...
#10.7
exp(0.61) #bp coefficent

#This is the change in odds when the prosocial is on the left side , i.e. odds increase by 84%
# but this depends on alpha and any other predictor variables.
