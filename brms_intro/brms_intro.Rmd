...
If you want to give the same prior to all members of a class, then just name the class.  In the example I gave above (repeated below) I am setting the priors for all beta coefficients (trt and species) to be normal(0,10).
...
To see all priors that you could specify for a given model and what they are called, use `get_prior()`
